...
@section('content')
    ...
    <div class="max-w-5xl mx-auto">
        ...
        <!-- CARD -->
        <form method="POST" action="{{ isset($book) ? '/admin/books/' . $book->id : '/admin/books' }}"
            ...
            <div>
                ...
                <div class="mt-2 mb-4">
                    ...
                    @if(isset($book) && $book->cover)
                        <img src="{{ asset('storage/' . $book->cover) }}" id="preview" class="w-40 rounded-xl shadow-lg">
                    @else
                ...
                <!-- INPUT -->
                <input type="file" name="cover" id="coverInput" class="text-sm text-gray-400">

            </div>

            <!-- BUTTON -->
            <div class="col-span-2 flex justify-end mt-4">
                <button class="px-6 py-2.5 bg-white text-black rounded-xl font-medium hover:scale-105 transition">
